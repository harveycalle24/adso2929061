    ...
    <div class="flex flex-wrap gap-4 items-center justify-center mb-6">
        ...
        <div class="card text-white bg-[#0006] w-96 shadow-sm">
            <figure class="h-[240px] bg-black/10">
                <img
                    ...
                    src="{{ asset('images/dashboard/user.png') }}" alt="Users Module" />
            </figure>
            <div class="card-body">
                <h2 class="card-title">
        ...
        <div class="card text-white bg-[#0006] w-96 shadow-sm">
            <figure class="h-[240px] bg-black/10">
                <img
                    class="object-contain w-full h-full"
                    src="{{ asset('images/dashboard/modulo-pets.png') }}" alt="Pets Module" />
            </figure>
            <div class="card-body">
                <h2 class="card-title">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-10" fill="currentColor" viewBox="0 0 256 256">
        ...
        <div class="card text-white bg-[#0006] w-96 shadow-sm">
            <figure class="h-[240px]">
                <img
                    ...
                    src="{{ asset('images/dashboard/user.png') }}" alt="My Profile" />
            </figure>
            <div class="card-body">
                <h2 class="card-title">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
        ...
        <div class="card text-white bg-[#0006] w-96 shadow-sm">
            <figure class="h-[240px]">
                <img
                    class="object-cover w-full h-full"
                    src="{{ asset('images/dashboard/adoption.png') }}" alt="My Adoptions" />
            </figure>
            <div class="card-body">
                <h2 class="card-title">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
        ...
        <div class="card text-white bg-[#0006] w-96 shadow-sm">
            <figure class="h-[240px]">
                <img
                    class="object-cover w-full h-full"
                    src="{{ asset('images/dashboard/adoption.png') }}" alt="Adoptions" />
            </figure>
            <div class="card-body">
                <h2 class="card-title">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
