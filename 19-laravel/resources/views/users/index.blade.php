        ...
        <table class="table">
            ...
            <tbody class="datalist">
                ...
                <tr class="even:bg-white/10">
                    ...
                    <td>
                        <div class="avatar">
                            <div class="mask mask-squircle w-12 h-12 md:w-24 md:h-24">
                                <img src="{{ $user->photo_url }}" alt="{{ $user->fullname }}" onerror="this.src='{{ asset('images/users/no-photo.png') }}'" />
                            </div>
                        </div>
                    </td>
                    <td>{{ $user->document }}</td>
            ...
            <tfoot>
                <tr>
                    <td colspan="7">{{$users->links('partials.pagination')}}</td>
                </tr>
            </tfoot>
        </table>
    </div>
...
<script>
    ...
    $('.btn-delete').click(function(e) {
        ...
        Swal.fire({
            title: "Are you sure?",
            text: "You won't be able to revert this! User: " + fullname,
            icon: "warning",
